...
class VkBot:
    ...
    def new_message(self, message):
        ...
        if message.upper() == self._COMMANDS[0]:
            print(f'Список доступных команд:{NL} '
                  f'"?" - вывести список доступных команд;{NL}'
                  f'"ВОЗРАСТ ОТ ??" - задать нижнюю границу возраста искомого партнера, пример команды: возраст от 18;{NL}'
                  f'"ВОЗРАСТ ДО ??" - задать верхнюю границу возраста искомого партнера, пример команды: возраст до 35;{NL}'
                  f'"ПОЛ ?" - задать пол искомого партнера из следующих: 1 — женский, 2 — мужской, 0 — любой, пример команды: пол 1;{NL}'
                  ...
                  f'например 1 - Москва, 2 - Спб, пример команды: город 1;{NL}'
                  f'"СЕМ ПОЛОЖ ?" - задать семейное положение искомого партнера из следующих: 1 — не женат (не замужем), 2 — встречается, 3 — помолвлен(-а), '
                  f'4 — женат (замужем), 5 — всё сложно, 6 — в активном поиске, 7 — влюблен(-а), 8 — в гражданском браке, пример команды: сем полож 1;{NL}'
                  f'"+" - лайк, нравится, сохранение партнера в БД (команда доступна в режиме просмотра партнеров), пример команды: +;{NL}'
                  f'"-" - дизлайк, не нравится, удаление партнера из БД (команда доступна в режиме просмотра партнеров), пример команды: -;{NL}'
                  f'"ТОП" - вывести из БД список топ-10 сохраненных партнеров, пример команды: топ;{NL}'
                  f'"-1" - удалить из списка топ-10 партнера №1 (команда доступна в режиме просмотра партнеров), пример команды: -1;{NL}'
                  f'"-2" - удалить из списка топ-10 партнера №2 (команда доступна в режиме просмотра партнеров), пример команды: -2;{NL}'
                  f'"-3" - удалить из списка топ-10 партнера №3 (команда доступна в режиме просмотра партнеров), пример команды: -3;{NL}'
                  f'"-4" - удалить из списка топ-10 партнера №4 (команда доступна в режиме просмотра партнеров), пример команды: -4;{NL}'
                  f'"-5" - удалить из списка топ-10 партнера №5 (команда доступна в режиме просмотра партнеров), пример команды: -5;{NL}'
                  f'"-6" - удалить из списка топ-10 партнера №6 (команда доступна в режиме просмотра партнеров), пример команды: -6;{NL}'
                  f'"-7" - удалить из списка топ-10 партнера №7 (команда доступна в режиме просмотра партнеров), пример команды: -7;{NL}'
                  f'"-8" - удалить из списка топ-10 партнера №8 (команда доступна в режиме просмотра партнеров), пример команды: -8;{NL}'
                  f'"-9" - удалить из списка топ-10 партнера №9 (команда доступна в режиме просмотра партнеров), пример команды: -9;{NL}, '
                  f'"-10" - удалить из списка топ-10 партнера №10 (команда доступна в режиме просмотра партнеров), пример команды: -10;{NL}'
                  f'"ПРЕРВАТЬ" - временно прекратить работу с программой')
            return f"Вопрос №1: напишите возраст партнера ОТ. Формат ответа: ВОЗРАСТ ОТ ??. Например: " \
        ...
        # *.Старт опроса
            ...
            return f'Добрый день, {self._USERNAME}. Я сваха Диана приветствую вас в группе поиска большой и светлой любви! Если вы впервые у нас, ' \
